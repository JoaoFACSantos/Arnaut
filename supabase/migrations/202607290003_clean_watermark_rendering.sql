alter table public.albums
  alter column watermark_opacity set default 0.680,
  alter column watermark_scale set default 0.220;

update public.albums
set
  watermark_opacity = 0.680,
  watermark_scale = 0.220,
  watermark_version = watermark_version + 1
